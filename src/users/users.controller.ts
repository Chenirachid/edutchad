...
export class UsersController {
  ...
  @Post('import-eleves')
  @Roles(Role.ADMIN, Role.CHEF_ETABLISSEMENT)
  importEleves(@Body() dto: ImportElevesDto, @CurrentUser() user: JwtPayload) {
    return this.usersService.importEleves(dto, user);
  }
